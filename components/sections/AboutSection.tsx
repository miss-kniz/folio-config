        ...
        <section className="bg-primary-light text-[13px] py-4 md:py-8 px-4 mt-2">
            <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-between  md:gap-8 items-center">
                ...
                <div className="flex-1">
                    ...
                    <Heading
                        as="h2"
                        normalText="Short Intro"
                        highlightText="About Me"
                        center={false}
                    />

                    <SimplePara className="mt-4 font-light md:text-sm">
                        I’m <strong>Mehak Fatima Naqvi</strong> — Full-Stack Developer, Frontend Specialist, and aspiring freelancer. From humble beginnings, I’ve built my skills step by step to create fast, scalable, and user-friendly web applications. I love transforming challenges into clean, maintainable solutions that make a real impact.
                    </SimplePara>
